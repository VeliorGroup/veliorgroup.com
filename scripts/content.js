// Velior Group — translations & content
const COPY = {
  en: {
    nav: {
      home: "Home",
    ...
    hero: {
      ...
      title: ["CRM, automation, and AI", "engineered for growth."],
    ...
    footer: {
      ...
      sections: [
        { t: "Company", l: [["About", "about"], ["Services", "services"], ["Contact", "contact"]] },
        { t: "Capabilities", l: [["Salesforce", "services"], ["Automation", "services"], ["Full-stack", "services"], ["AI & agents", "services"]] }
      ],
    ...
    ui: {
      ...
      buildNext: ["Let's build your", "next chapter."],
      operatingPrinciples: "operating principles",
      whatWeBelieve: "What we believe, in practice.",
      threePillars: ["Three pillars.", "One operating system", "for your business."],
      pillar: "pillar",
      ambitiousOperators: ["A European consultancy for", "ambitious operators."],
      tellUs: ["Tell us about your", "next move."],
  ...
  it: {
    ...
    hero: {
      ...
      title: ["CRM, automazione e AI", "al servizio della crescita."],
    ...
    footer: {
      ...
      sections: [
        { t: "Azienda", l: [["Chi siamo", "about"], ["Servizi", "services"], ["Contatti", "contact"]] },
        { t: "Capabilities", l: [["Salesforce", "services"], ["Automazione", "services"], ["Full-stack", "services"], ["AI & agenti", "services"]] }
      ],
      legal: "© 2026 Velior Group · P.IVA IT00000000000",
      privacy: "Privacy",
      cookies: "Cookie"
    ...
    ui: {
      ...
      buildNext: ["Costruiamo il tuo", "prossimo capitolo."],
      operatingPrinciples: "principi operativi",
      whatWeBelieve: "Cosa crediamo, nella pratica.",
      threePillars: ["Tre pilastri.", "Un sistema operativo", "per la tua azienda."],
      pillar: "pilastro",
      ambitiousOperators: ["Una consulenza europea per", "operatori ambiziosi."],
      tellUs: ["Raccontaci la tua", "prossima mossa."],
